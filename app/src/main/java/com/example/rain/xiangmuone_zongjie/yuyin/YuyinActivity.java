package com.example.rain.xiangmuone_zongjie.yuyin;
...
import com.example.rain.xiangmuone_zongjie.yuyin.XFBean;
    ...
    private void sayin() {
        ...
        mDialog.setListener(new RecognizerDialogListener() {
            ...
            public void onResult(RecognizerResult recognizerResult, boolean b) {
                ...
                String anwser = "不好意思,脑容量太小,没能听清你说啥";
                if (result.contains("哈哈哈")) {
                    anwser = "笑几把啥";
                } else if (result.contains("美女")) {
                    anwser = "叫我吗";
                } else if (result.contains("认识霍远东吗")) {
                    anwser = "霍远东,智慧与魅力的化身啊";
                } else if (result.contains("你的名字")) {
                    anwser = "你妈妈";
                }else if (result.contains("叫东哥")) {
                    anwser = "东哥好，东哥威武霸气";
